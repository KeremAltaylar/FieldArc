...
def build():
    ...
    targets = {
        "core_test": ["core/core.cpp", "core/mix.cpp", "core/place.cpp", "core/webm.cpp", "core/sections.cpp", *devices, "core/test.cpp"],
        "stretch_test": ["core/core.cpp", "core/mix.cpp", "core/place.cpp", "core/webm.cpp", "core/sections.cpp", "core/devices/test_devices.cpp", "core/tests/stretch_test.cpp"],
    }
    exe = {}
