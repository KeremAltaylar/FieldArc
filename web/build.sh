...
em++ -std=c++17 -O2 --no-entry -sSTANDALONE_WASM -sALLOW_MEMORY_GROWTH=1 -sINITIAL_MEMORY=32MB \
  ...
  core/core.cpp core/mix.cpp core/place.cpp core/sections.cpp core/webm.cpp core/resample.cpp core/piece.cpp core/engine.cpp core/devices/*.cpp -o build/web/core.wasm
